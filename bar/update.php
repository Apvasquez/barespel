<?php
    ...
    if(isset($_POST["bar_nombre"]))
    {
        ...
        $sql = "UPDATE bar SET cam_id=".$cam_id.
            ",bar_nombre='".$bar_nombre."'".
            ",bar_abierto=".$bar_abierto.
            " WHERE bar_id=".$bar_id;              
        $conn->query($sql);       
        $conn->close();        
    ...
    $bar_id=$_GET["bar_id"];
    $sql = "SELECT b.cam_id,cam_nombre,bar_id,bar_nombre,bar_abierto "
            ."FROM bar b,campus c "
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col border">
                ...
                <input type="radio" class="form-control" id="bar_cerrado" name="bar_abierto" value="0"<?php echo $cerrado?>>
                </div>
                </div>
            </div>       
