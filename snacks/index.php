...
<body>
    <div class="container">
        <div class="row">
            <div class="col">
 <h1 class="text-center"> GESTIÓN DE SNACKS</h1>
            ...
            <div class="col">
               ...
               <a href="create.php" class="btn btn-success">Nuevo</a><br>
                ...
                ?>          <tr>
                            ...
                            <td class="text-center"> <?php if($row["sna_disponible"]==1)
                                echo"SI";
                                else echo "NO";?>
                               </td>
                            
                            <td class="text-center"> <a href="view.php?sna_id=<?php echo $row["sna_id"]?>" class="btn btn-info">Ver</a> 
