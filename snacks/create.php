<?php
    ...
    if(isset($_POST["sna_nombre"]))
    {
        ...
        $sql = "INSERT INTO snack  (sna_id,bar_id,sna_nombre,sna_precio,sna_disponible) VALUES(0,".$bar_id.",'".$sna_nombre."','".$sna_precio."',".$sna_disponible.")";
        $conn->query($sql);
        $conn->close();
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col border">
                ...
                <input type="text" class="form-control" id="men_nombre" name="sna_nombre">
                </div>
                <div class="form-group">
                <label for="men_precio">Precio</label>
                <input type="text" class="form-control" id="men_precio" name="sna_precio">
                </div>
                <div class="form-group">
                <label for="men_abierto">Abierto</label>
                <input type="radio" class="form-control" id="men_abierto" name="sna_disponible" value="0">
                <label for="men_cerrado">Cerrado</label>
                <input type="radio" class="form-control" id="men_cerrado" name="sna_disponible" value="1">
                </div>
