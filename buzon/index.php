               ...
               <a href="create.php" class="btn btn-success">Nuevo</a><br>
                ...
                ?> 
                        <tr>
                            ...
                            <td class="text-center"> <a href="view.php?buz_id=<?php echo $row["buz_id"]?>" class="btn btn-info">Ver</a> 
                            <a href="update.php?buz_id=<?php echo $row["buz_id"]?>" class="btn btn-warning">Editar</a> 
